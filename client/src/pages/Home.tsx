    ...
    <div className="bg-app-cream">
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-lg bg-app-green p-6 text-white">
            <BikeIcon className="mb-5 size-9" aria-hidden="true" />
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm">
            <MapPinIcon className="mb-5 size-9 text-app-green" aria-hidden="true" />
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm">
            <CreditCardIcon className="mb-5 size-9 text-app-green" aria-hidden="true" />
            <h3 className="text-xl font-semibold text-zinc-950">Flexible payment</h3>
            <p className="mt-2 text-sm leading-6 text-zinc-500">
              Cash on Delivery today, with card and wallet integrations ready to grow.
            </p>
          </div>
        </div>
      </section>
